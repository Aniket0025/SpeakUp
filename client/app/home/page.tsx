    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        <section className="grid md:grid-cols-2 gap-10 items-center mb-20">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-950/40 text-violet-700 dark:text-violet-300 text-xs font-bold mb-4">
          ...
          <div className="relative">
            <div className="rounded-[40px] p-8 bg-card border border-border shadow-xl">
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-black text-foreground mb-8 tracking-tight">Why SpeakUp?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-8 rounded-[32px] bg-card border border-border shadow-sm hover:shadow-md transition-all">
              <Rocket className="h-8 w-8 text-violet-600 mb-4" />
              <h3 className="font-bold text-lg mb-2">Gamified Progress</h3>
              <p className="text-muted-foreground">Levels, XP, and leaderboards to keep you motivated.</p>
            </div>
            <div className="p-8 rounded-[32px] bg-card border border-border shadow-sm hover:shadow-md transition-all">
              <Shield className="h-8 w-8 text-emerald-600 mb-4" />
              <h3 className="font-bold text-lg mb-2">Safe Environment</h3>
              <p className="text-muted-foreground">Practice confidently with peers and AI.</p>
            </div>
            <div className="p-8 rounded-[32px] bg-card border border-border shadow-sm hover:shadow-md transition-all">
              <Sparkles className="h-8 w-8 text-orange-600 mb-4" />
              <h3 className="font-bold text-lg mb-2">AI-Powered Feedback</h3>
              <p className="text-muted-foreground">Actionable insights to improve every session.</p>
            </div>
          </div>
        </section>
