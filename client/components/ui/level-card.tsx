...
export function LevelCard({ level, currentXP, nextLevelXP, streak }: LevelCardProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-white border border-violet-100 p-6 shadow-lg">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">{currentXP} XP earned</p>
        ...
        <div className="text-right">
          <p className="text-sm text-gray-500">Next level at</p>
